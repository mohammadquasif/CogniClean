...
title CogniClean - Setup v1.1
color 0B
cls

echo.
echo  ============================================================
echo    CogniClean Assistant v1.0.0
echo    by Mohammad Quasif  ^|  DBA AI ^| B.Tech CS
echo    github.com/mohammadquasif/CogniClean
echo  ============================================================
echo.

set "SCRIPT_DIR=%~dp0"
set "TEMP_DIR=%TEMP%\CogniCleanSetup"
...
set "SHORTCUT=%USERPROFILE%\Desktop\CogniClean.lnk"
...
powershell -NoProfile -Command ^
  ...
  "$s.Description = 'CogniClean by Quasif';" ^
...
echo.
echo    Launching CogniClean now...
echo  ============================================================
echo.

:: Kill any stale instance before launching fresh
taskkill /F /IM python.exe /FI "WINDOWTITLE eq CogniClean*" >nul 2>&1
taskkill /F /IM pythonw.exe /FI "WINDOWTITLE eq CogniClean*" >nul 2>&1
taskkill /F /IM CogniClean.exe >nul 2>&1
