@echo off
:: ============================================================
:: CogniClean Assistant - One-Click EXE Builder
:: Requires: Python 3.11+, PyInstaller
:: ============================================================

echo ==========================================
echo  CogniClean - Build Script
echo ==========================================
...
echo [3/4] Build complete! Output: dist\CogniClean\
echo [4/4] To create installer: run Inno Setup on installer\setup.iss

echo.
echo ==========================================
echo  BUILD SUCCESSFUL
echo  EXE: dist\CogniClean\CogniClean.exe
echo ==========================================
pause
