...
class SettingsPage(QWidget):
    ...
    def _test_voice(self):
        ...
        v = VoiceAssistant()
        v.start()
        v.speak(f"Hello {name}! This is how I will greet you. Your CogniClean assistant is ready.")
    ...
    def _configure_startup(self, enable: bool):
        ...
        try:
            ...
            if enable:
                winreg.SetValueEx(key, "CogniClean", 0, winreg.REG_SZ, cmd)
            else:
                try:
                    winreg.DeleteValue(key, "CogniClean")
    ...
    def _create_shortcut(self):
        ...
        try:
            ...
            shortcut_path = os.path.join(desktop, "CogniClean.lnk")
            shell = Dispatch("WScript.Shell")
            shortcut = shell.CreateShortCut(shortcut_path)
            shortcut.Targetpath = pythonw
            shortcut.Arguments = f'"{app_py}"'
            shortcut.WorkingDirectory = os.path.dirname(app_py)
            shortcut.Description = "CogniClean Assistant by Mohammad Quasif"
    ...
    def _build_general_tab(self):
        ...
        cl.addWidget(self._lbl("CogniClean Assistant v1.0.0"))
        ...
        uninstall_btn = NeonButton("🗑️ Uninstall CogniClean", "#FF2D55")
    ...
    def _uninstall_app(self):
        ...
        try:
            ...
            removed = False
            for reg_name in ["CogniClean", "CogniClear", "AISystemOptimizer", "AI System Optimizer", "AIOptimizer"]:
                try:
        ...
        try:
            ...
            sc = os.path.join(desktop, "CogniClean.lnk")
